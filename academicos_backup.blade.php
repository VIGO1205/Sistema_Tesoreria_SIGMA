...
<div class="p-8 m-4 bg-gray-100 dark:bg-white/[0.03] rounded-2xl">
                ...
                <div id="filtrosEstandar" class="transition-all duration-300 {{ request('usar_fechas') ? 'hidden' : '' }}">
                    ...
                    <div>
                        @php
                            ...
                            array_unshift($periodosArray, ['valor' => 'all', 'texto' => 'Todos los períodos']);
                        @endphp
    ...
    <div class="mt-8 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        ...
        <!-- Gráfico 5: Estado Prematrículas -->
        <div>
            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4 flex items-center">
...
console.log('Datos recibidos del controlador:');
console.log('nivelesLabels:', @json($nivelesLabels ?? []));
console.log('nivelesData:', @json($nivelesData ?? []));
console.log('gradosLabels:', @json($gradosLabels ?? []));
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (canvas1 && nivelesLabels.length > 0) {
        ...
        console.log('✓ Gráfico 1 (Nivel) creado');
    }
    ...
    if (canvas2 && gradosLabels.length > 0) {
        ...
        console.log('✓ Gráfico 2 (Grado) creado');
    }
    ...
    if (canvas3 && escalasLabels.length > 0) {
        ...
        console.log('✓ Gráfico 3 (Escala) creado');
    }
    ...
    if (canvas4 && sexoLabels.length > 0) {
        ...
        console.log('✓ Gráfico 4 (Sexo) creado');
    }
    ...
    if (canvas5 && estadosLabels.length > 0) {
        ...
        console.log('✓ Gráfico 5 (Estado Premat) creado');
    }
    ...
    if (canvas6 && mesesLabels.length > 0) {
        ...
        console.log('✓ Gráfico 6 (Mes) creado');
    }
    
    // GRÁFICO 7: Aprobación
    ...
    if (canvas7 && aprobLabels.length > 0) {
        ...
        console.log('✓ Gráfico 7 (Aprobación) creado');
    }
    ...
    if (canvas8 && capacidadLabels.length > 0) {
        ...
        console.log('✓ Gráfico 8 (Capacidad) creado');
    }
...
// Toggle para mostrar/ocultar campos de fecha
document.getElementById('usarFechasPersonalizadas').addEventListener('change', function() {
...
// Si hay fechas en la URL, mostrar los campos y marcar el checkbox
if (document.getElementById('fecha_inicio').value || document.getElementById('fecha_fin').value) {
    document.getElementById('usarFechasPersonalizadas').checked = true;
    document.getElementById('camposFechas').classList.remove('hidden');
}
