<style>
    .metodo-logo { background: #00c896; color: white; padding: 2rem; border-radius: 10px; text-align: center; margin-bottom: 2rem; }
            ...
            <div class="card">
                <div class="card-body">
                    <div class="metodo-logo">
                        <img src="https://marketingperu.beglobal.biz/wp-content/uploads/2024/09/logo-plin-fondo-transparente.png" alt="Plin" style="height: 100px; object-fit: contain;">
                        <h3 class="mt-3">Pago con Plin</h3>
                    </div>
                    ...
                    <form action="{{ route('familiar_pago_pago_realizar_procesar') }}" method="POST" id="pagoForm">
                        ...
                        <div class="mb-4">
                            <label class="form-label">Número de celular registrado en Plin</label>
                        ...
                        <button type="submit" class="btn btn-success btn-lg w-100" style="background: #00C1A2; border-color: #00C1A2;">
