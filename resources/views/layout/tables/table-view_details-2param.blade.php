        ...
        <tr>
          ...
          <td class="py-3">
            <div class="flex gap-4 items-center">
              ...
              <a href="{{ route($edit, [$fila[4], $fila[3]])  }}" class="edit-button text-gray-600 text-theme-sm dark:text-gray-400">
                Editar
              </a>
              @endcan
