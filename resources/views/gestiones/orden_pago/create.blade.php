        ...
        <div class="grid grid-cols-1 sm:grid-cols-6 gap-2 sm:col-span-2 lg:col-span-2">
            <div class="sm:col-span-3 flex flex-col">
                ...
                <div class="min-h-[20px]">
                    <p id="error_codigo_alumno" class="text-xs text-red-500 mt-1 hidden"></p>
                    @error('codigo_alumno')
            ...
            <div class="sm:col-span-3 flex sm:justify-end items-center gap-2">
                <button type="button" id="btnLimpiarBusqueda"
                    class="flex items-center rounded-lg border border-blue-300 bg-blue-200 overflow-hidden focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400">
                    
                    <span class="w-full px-4 py-2 text-sm font-semibold text-gray-800">
                        Limpiar
                    </span>

                    <span class="px-3 py-2 bg-blue-300 border-l border-blue-400 flex items-center justify-center">
                ...
                <button type="button" id="btnBuscarAlumno"
                    class="flex items-center rounded-lg border border-amber-300 bg-amber-200 overflow-hidden focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-400">
                    <span class="w-full px-4 py-2 text-sm font-semibold text-gray-800">
                        Buscar Alumno
                    </span>
                    <span class="px-3 py-2 bg-amber-300 border-l border-amber-400 flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor" class="h-5 w-5 text-gray-700">
