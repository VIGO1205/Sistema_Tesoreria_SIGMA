...
@section('just-after-html') 
    <div class="delete-modal hidden">
        @include('layout.modals.modal-01', [
            ...
            'last_warning_message' => 'Borrar esto afectará a todo lo que esté vinculado a este Docente',
...
@section('contenido')
    ...
    @if(isset($data['edited']))
        @include('layout.alerts.animated.timed-alert',[
        'message' => 'El docente ha sido editado exitosamente.',
    ...
    @if(isset($data['abort']))
        @include('layout.alerts.animated.timed-alert',[
        'message' => 'La acción sobre el docente ha sido cancelada.',
    ...
    @include('layout.tables.table-01-2', $data) {{-- -esta linea es todo xd --}}
